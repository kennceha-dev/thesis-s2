...
Konteks dokumen berbahasa Indonesia memperkuat urgensi masalah ini. Dataset CORD menunjukkan bahwa struk berbahasa Indonesia memiliki variasi struktur, anotasi OCR, dan label semantik yang relevan untuk studi post-OCR parsing [5]. Di luar struk, dokumen administratif lokal juga sering memuat format penulisan, singkatan, stempel, tanda tangan, dan elemen non-teks yang dapat mempengaruhi kualitas ekstraksi.
